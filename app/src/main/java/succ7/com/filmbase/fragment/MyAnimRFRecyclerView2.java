 ...
 */
public class MyAnimRFRecyclerView2 extends RecyclerView implements Runnable {

    private Context mContext;

    private static MyAnimRFRecyclerView2 rfView;
    ...
    public MyAnimRFRecyclerView2(Context context) {
        this(context, null);
    }

    public MyAnimRFRecyclerView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyAnimRFRecyclerView2(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setHeaderImage(ImageView headerImage) {
        ...
        headerImageHeight = MyAnimRFRecyclerView2.this.headerImage.getHeight();
        // 防止第一次拉伸的时候headerImage.getLayoutParams().height = 0
        if (headerImageHeight <= 0) {
            headerImageHeight = MyAnimRFRecyclerView2.this.headerImage.getLayoutParams().height;
        } else {
    ...
    public void setAdapter(Adapter adapter) {
        if (mHeaderViews.isEmpty() || headerImage == null && isEnable) {
            ...
            headerImage = new MyAnimImageView(mContext);
            ((MyAnimImageView) headerImage).setColor(progressColor, bgColor);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        LogUtils.i("onTouch event4 = " + MotionEvent.actionToString(ev.getAction()));
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        LogUtils.i("onTouch event3 = " + MotionEvent.actionToString(e.getAction()));
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        LogUtils.i("onTouch event1 = " + MotionEvent.actionToString(ev.getAction()));
        switch (ev.getAction()) {
