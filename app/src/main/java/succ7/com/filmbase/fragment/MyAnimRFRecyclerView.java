 ...
 */
public class MyAnimRFRecyclerView extends RecyclerView implements Runnable {

    private Context mContext;

    private static MyAnimRFRecyclerView rfView;
    ...
    public MyAnimRFRecyclerView(Context context) {
        this(context, null);
    }

    public MyAnimRFRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyAnimRFRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setHeaderImage(ImageView headerImage) {
        ...
        headerImageHeight = MyAnimRFRecyclerView.this.headerImage.getHeight();
        // 防止第一次拉伸的时候headerImage.getLayoutParams().height = 0
        if (headerImageHeight <= 0) {
            headerImageHeight = MyAnimRFRecyclerView.this.headerImage.getLayoutParams().height;
        } else {
