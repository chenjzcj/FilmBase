...
public abstract class AsyncTask<Params, Progress, Result> {
     ...
     */
    ;
    public static final Executor SERIAL_EXECUTOR = Build.VERSION.SDK_INT > Build.VERSION_CODES.GINGERBREAD_MR1 ? new SerialExecutor() :
            Executors.newSingleThreadExecutor(sThreadFactory);

    public static final Executor MULTI_THREAD_EXECUTOR =
