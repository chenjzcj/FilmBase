...
public class StatusBarUtils {
    ...
    public static void setTranslucentStatus(boolean on, Activity activity, int colorResId) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            tintManager.setStatusBarTintResource((colorResId != 0) ? colorResId : android.R.color.black);//通知栏所需颜色
            tintManager.setNavigationBarTintResource((colorResId != 0) ? colorResId : android.R.color.black);
        }
    }
